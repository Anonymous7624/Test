...
def _default_settings_doc(user_id: int) -> dict:
    return {
        ...
        "worker_last_completed_raw_collected": 0,
        "worker_last_completed_step1_kept": 0,
        "worker_last_completed_step2_matched": 0,
        "worker_last_completed_step3_scored": 0,
        "worker_last_completed_step4_saved": 0,
        "worker_last_completed_alerts_sent": 0,
        "worker_pipeline_step3_rank": 0,
        "worker_pipeline_step3_total": 0,
...
def settings_from_doc(doc: dict) -> UserSettingsState:
    ...
    return UserSettingsState(
        ...
        worker_last_completed_raw_collected=int(d.get("worker_last_completed_raw_collected", 0)),
        worker_last_completed_step1_kept=int(d.get("worker_last_completed_step1_kept", 0)),
        worker_last_completed_step2_matched=int(d.get("worker_last_completed_step2_matched", 0)),
        worker_last_completed_step3_scored=int(d.get("worker_last_completed_step3_scored", 0)),
        worker_last_completed_step4_saved=int(d.get("worker_last_completed_step4_saved", 0)),
        worker_last_completed_alerts_sent=int(d.get("worker_last_completed_alerts_sent", 0)),
        worker_pipeline_step3_rank=int(d.get("worker_pipeline_step3_rank", 0)),
        worker_pipeline_step3_total=int(d.get("worker_pipeline_step3_total", 0)),
